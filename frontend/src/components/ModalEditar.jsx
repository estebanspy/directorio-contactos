...
function ModalEditar({ contacto, onCerrar, onGuardar, error }) {
  ...
  return (
    <div className="overlay">
      <div className="modal">
        <h2 className="modal-titulo">Editar Contacto</h2>
        ...
        <div className="modal-acciones">
          <button className="boton boton-secundario" onClick={manejarGuardar}>
            Guardar
          </button>
          <button className="boton boton-peligro" onClick={onCerrar}>
            Cancelar
          </button>
        </div>
      </div>
